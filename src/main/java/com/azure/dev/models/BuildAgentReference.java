...
/** The BuildAgentReference model. */
@Fluent
public final class BuildAgentReference {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(BuildAgentReference.class);
     ...
     * @return the BuildAgentReference object itself.
     */
    public BuildAgentReference withId(Integer id) {
        this.id = id;
        return this;
    }
     ...
     * @return the BuildAgentReference object itself.
     */
    public BuildAgentReference withName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the BuildAgentReference object itself.
     */
    public BuildAgentReference withUrl(String url) {
        this.url = url;
        return this;
    }
