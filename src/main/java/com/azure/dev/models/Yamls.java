...
/**
 * Resource collection API of Yamls.
 */
public interface Yamls {
    /**
     ...
     */
    Response<YamlBuild> getWithResponse(String organization, String project, int definitionId, Integer revision,
     ...
     */
    YamlBuild get(String organization, String project, int definitionId);
}
