...
/** The XamlBuildReference model. */
@Fluent
public final class XamlBuildReference {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(XamlBuildReference.class);
     ...
     * @return the XamlBuildReference object itself.
     */
    public XamlBuildReference withId(Integer id) {
        this.id = id;
        return this;
    }
     ...
     * @return the XamlBuildReference object itself.
     */
    public XamlBuildReference withName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the XamlBuildReference object itself.
     */
    public XamlBuildReference withUrl(String url) {
        this.url = url;
        return this;
    }
