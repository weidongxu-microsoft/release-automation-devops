...
public final class BuildsClientImpl implements BuildsClient {
    private final ClientLogger logger = new ClientLogger(BuildsClientImpl.class);
    ...
    private interface BuildsService {
        ...
        Mono<Response<List<BuildInner>>> list(
            @HostParam("$host") String endpoint,
            @PathParam("organization") String organization,
            @PathParam("project") String project,
            @QueryParam("definitions") String definitions,
            @QueryParam("queues") String queues,
            @QueryParam("buildNumber") String buildNumber,
            @QueryParam("minTime") OffsetDateTime minTime,
            @QueryParam("maxTime") OffsetDateTime maxTime,
            @QueryParam("requestedFor") String requestedFor,
            @QueryParam("reasonFilter") BuildReason reasonFilter,
            @QueryParam("statusFilter") BuildStatus statusFilter,
            @QueryParam("resultFilter") BuildResult resultFilter,
            @QueryParam("tagFilters") String tagFilters,
            ...
            @QueryParam("queryOrder") BuildQueryOrder queryOrder,
            @QueryParam("branchName") String branchName,
            @QueryParam("buildIds") String buildIds,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<BuildInner>> queue(
            @HostParam("$host") String endpoint,
            @PathParam("organization") String organization,
            @PathParam("project") String project,
            @QueryParam("ignoreWarnings") Boolean ignoreWarnings,
            @QueryParam("checkInTicket") String checkInTicket,
            @QueryParam("sourceBuildId") Integer sourceBuildId,
            @QueryParam("definitionId") Integer definitionId,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") BuildInner body,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<List<BuildInner>>> updateBuilds(
            @HostParam("$host") String endpoint,
            @PathParam("organization") String organization,
            @PathParam("project") String project,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") List<BuildInner> body,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<BuildInner>> updateBuild(
            @HostParam("$host") String endpoint,
            @PathParam("organization") String organization,
            @PathParam("project") String project,
            @PathParam("buildId") int buildId,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<List<ChangeInner>>> getBuildChanges(
            @HostParam("$host") String endpoint,
            @PathParam("organization") String organization,
            @PathParam("project") String project,
            @PathParam("buildId") int buildId,
            @QueryParam("continuationToken") String continuationToken,
            @QueryParam("$top") Integer top,
            @QueryParam("includeSourceChange") Boolean includeSourceChange,
            @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<List<BuildLogInner>>> getBuildLogs(
            @HostParam("$host") String endpoint,
            @PathParam("organization") String organization,
            @PathParam("project") String project,
            @PathParam("buildId") int buildId,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<String>> getBuildLog(
            @HostParam("$host") String endpoint,
            @PathParam("organization") String organization,
            @PathParam("project") String project,
            @PathParam("buildId") int buildId,
            @PathParam("logId") int logId,
            @QueryParam("startLine") Long startLine,
            @QueryParam("endLine") Long endLine,
            @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<List<ResourceRefInner>>> getBuildWorkItemsRefs(
            @HostParam("$host") String endpoint,
            @PathParam("organization") String organization,
            @PathParam("project") String project,
            @PathParam("buildId") int buildId,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<List<ResourceRefInner>>> getBuildWorkItemsRefsFromCommits(
            @HostParam("$host") String endpoint,
            @PathParam("organization") String organization,
            @PathParam("project") String project,
            @PathParam("buildId") int buildId,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<List<ChangeInner>>> getChangesBetweenBuilds(
            @HostParam("$host") String endpoint,
            @PathParam("organization") String organization,
            @PathParam("project") String project,
            @QueryParam("fromBuildId") Integer fromBuildId,
            @QueryParam("toBuildId") Integer toBuildId,
            @QueryParam("$top") Integer top,
            @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<List<ResourceRefInner>>> getWorkItemsBetweenBuilds(
            @HostParam("$host") String endpoint,
            @PathParam("organization") String organization,
            @PathParam("project") String project,
            @QueryParam("fromBuildId") int fromBuildId,
            @QueryParam("toBuildId") int toBuildId,
            @QueryParam("$top") Integer top,
            @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<Response<List<BuildInner>>> listWithResponseAsync(
        String organization,
        String project,
        String definitions,
        String queues,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<List<BuildInner>> listAsync(
        String organization,
        String project,
        String definitions,
        String queues,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<List<BuildInner>> listWithResponse(
        String organization,
        String project,
        String definitions,
        String queues,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<BuildInner>> queueWithResponseAsync(
        String organization,
        String project,
        BuildInner body,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<BuildInner> queueAsync(
        String organization,
        String project,
        BuildInner body,
        Boolean ignoreWarnings,
        ...
        Integer sourceBuildId,
        Integer definitionId) {
        return queueWithResponseAsync(
                organization, project, body, ignoreWarnings, checkInTicket, sourceBuildId, definitionId)
            .flatMap(
    ...
    public BuildInner queue(String organization, String project, BuildInner body) {
        ...
        final Integer sourceBuildId = null;
        final Integer definitionId = null;
        return queueAsync(organization, project, body, ignoreWarnings, checkInTicket, sourceBuildId, definitionId)
            .block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BuildInner> queueWithResponse(
        String organization,
        String project,
        BuildInner body,
        Boolean ignoreWarnings,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<List<BuildInner>>> updateBuildsWithResponseAsync(
        String organization, String project, List<BuildInner> body) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private Mono<Response<List<BuildInner>>> updateBuildsWithResponseAsync(
        ...
        context = this.client.mergeContext(context);
        return service
            .updateBuilds(this.client.getEndpoint(), organization, project, apiVersion, body, accept, context);
    }
    ...
    public List<BuildInner> updateBuilds(String organization, String project, List<BuildInner> body) {
        return updateBuildsAsync(organization, project, body).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<List<BuildInner>> updateBuildsWithResponse(
        String organization, String project, List<BuildInner> body, Context context) {
    ...
    private Mono<Response<Void>> deleteWithResponseAsync(String organization, String project, int buildId) {
        ...
        return FluxUtil
            .withContext(
                context ->
                    service.delete(this.client.getEndpoint(), organization, project, buildId, apiVersion, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Void>> deleteWithResponseAsync(
        ...
        final String apiVersion = "6.0";
        context = this.client.mergeContext(context);
        return service.delete(this.client.getEndpoint(), organization, project, buildId, apiVersion, context);
    }
    ...
    private Mono<Void> deleteAsync(String organization, String project, int buildId) {
        return deleteWithResponseAsync(organization, project, buildId).flatMap((Response<Void> res) -> Mono.empty());
    }
    ...
    public void delete(String organization, String project, int buildId) {
        deleteAsync(organization, project, buildId).block();
    }
    ...
    private Mono<Response<BuildInner>> getWithResponseAsync(
        String organization, String project, int buildId, String propertyFilters) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<BuildInner> getAsync(String organization, String project, int buildId, String propertyFilters) {
    ...
    public BuildInner get(String organization, String project, int buildId) {
        final String propertyFilters = null;
        return getAsync(organization, project, buildId, propertyFilters).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<BuildInner>> updateBuildWithResponseAsync(
        String organization, String project, int buildId, BuildInner body, Boolean retry) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private Mono<Response<BuildInner>> updateBuildWithResponseAsync(
        ...
        return service
            .updateBuild(
                this.client.getEndpoint(), organization, project, buildId, retry, apiVersion, body, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<BuildInner> updateBuildAsync(
        String organization, String project, int buildId, BuildInner body, Boolean retry) {
    ...
    public BuildInner updateBuild(String organization, String project, int buildId, BuildInner body) {
        final Boolean retry = null;
        return updateBuildAsync(organization, project, buildId, body, retry).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BuildInner> updateBuildWithResponse(
        String organization, String project, int buildId, BuildInner body, Boolean retry, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<List<ChangeInner>>> getBuildChangesWithResponseAsync(
        String organization,
        String project,
        int buildId,
        String continuationToken,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<List<ChangeInner>> getBuildChangesAsync(
        String organization,
        String project,
        int buildId,
        String continuationToken,
        Integer top,
        Boolean includeSourceChange) {
        return getBuildChangesWithResponseAsync(
                organization, project, buildId, continuationToken, top, includeSourceChange)
            .flatMap(
                (Response<List<ChangeInner>> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
    ...
    public List<ChangeInner> getBuildChanges(String organization, String project, int buildId) {
        ...
        final Integer top = null;
        final Boolean includeSourceChange = null;
        return getBuildChangesAsync(organization, project, buildId, continuationToken, top, includeSourceChange)
            .block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<List<ChangeInner>> getBuildChangesWithResponse(
        String organization,
        String project,
        int buildId,
        String continuationToken,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<List<BuildLogInner>>> getBuildLogsWithResponseAsync(
    ...
    private Mono<Response<List<BuildLogInner>>> getBuildLogsWithResponseAsync(
        ...
        context = this.client.mergeContext(context);
        return service
            .getBuildLogs(this.client.getEndpoint(), organization, project, buildId, apiVersion, accept, context);
    }
    ...
    private Mono<List<BuildLogInner>> getBuildLogsAsync(String organization, String project, int buildId) {
        return getBuildLogsWithResponseAsync(organization, project, buildId)
            .flatMap(
                (Response<List<BuildLogInner>> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
    ...
    public List<BuildLogInner> getBuildLogs(String organization, String project, int buildId) {
        return getBuildLogsAsync(organization, project, buildId).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<List<BuildLogInner>> getBuildLogsWithResponse(
        String organization, String project, int buildId, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<String>> getBuildLogWithResponseAsync(
        String organization, String project, int buildId, int logId, Long startLine, Long endLine) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<String> getBuildLogAsync(
        String organization, String project, int buildId, int logId, Long startLine, Long endLine) {
    ...
    public String getBuildLog(String organization, String project, int buildId, int logId) {
        final Long startLine = null;
        final Long endLine = null;
        return getBuildLogAsync(organization, project, buildId, logId, startLine, endLine).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<List<ResourceRefInner>>> getBuildWorkItemsRefsWithResponseAsync(
        String organization, String project, int buildId, Integer top) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private Mono<Response<List<ResourceRefInner>>> getBuildWorkItemsRefsWithResponseAsync(
        ...
        return service
            .getBuildWorkItemsRefs(
                this.client.getEndpoint(), organization, project, buildId, top, apiVersion, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<List<ResourceRefInner>> getBuildWorkItemsRefsAsync(
        String organization, String project, int buildId, Integer top) {
        return getBuildWorkItemsRefsWithResponseAsync(organization, project, buildId, top)
            .flatMap(
                (Response<List<ResourceRefInner>> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
    ...
    public List<ResourceRefInner> getBuildWorkItemsRefs(String organization, String project, int buildId) {
        final Integer top = null;
        return getBuildWorkItemsRefsAsync(organization, project, buildId, top).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<List<ResourceRefInner>> getBuildWorkItemsRefsWithResponse(
        String organization, String project, int buildId, Integer top, Context context) {
    ...
    private Mono<Response<List<ResourceRefInner>>> getBuildWorkItemsRefsFromCommitsWithResponseAsync(
        ...
        return service
            .getBuildWorkItemsRefsFromCommits(
                this.client.getEndpoint(), organization, project, buildId, top, apiVersion, body, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<List<ResourceRefInner>> getBuildWorkItemsRefsFromCommitsAsync(
        String organization, String project, int buildId, List<String> body, Integer top) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public List<ResourceRefInner> getBuildWorkItemsRefsFromCommits(
        String organization, String project, int buildId, List<String> body) {
        final Integer top = null;
        return getBuildWorkItemsRefsFromCommitsAsync(organization, project, buildId, body, top).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<List<ResourceRefInner>> getBuildWorkItemsRefsFromCommitsWithResponse(
        String organization, String project, int buildId, List<String> body, Integer top, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<List<ChangeInner>>> getChangesBetweenBuildsWithResponseAsync(
        String organization, String project, Integer fromBuildId, Integer toBuildId, Integer top) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<List<ChangeInner>> getChangesBetweenBuildsAsync(
        String organization, String project, Integer fromBuildId, Integer toBuildId, Integer top) {
    ...
    public List<ChangeInner> getChangesBetweenBuilds(String organization, String project) {
        ...
        final Integer toBuildId = null;
        final Integer top = null;
        return getChangesBetweenBuildsAsync(organization, project, fromBuildId, toBuildId, top).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<List<ChangeInner>> getChangesBetweenBuildsWithResponse(
        String organization, String project, Integer fromBuildId, Integer toBuildId, Integer top, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<List<ResourceRefInner>>> getWorkItemsBetweenBuildsWithResponseAsync(
        String organization, String project, int fromBuildId, int toBuildId, Integer top) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<List<ResourceRefInner>> getWorkItemsBetweenBuildsAsync(
        String organization, String project, int fromBuildId, int toBuildId, Integer top) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public List<ResourceRefInner> getWorkItemsBetweenBuilds(
        String organization, String project, int fromBuildId, int toBuildId) {
        final Integer top = null;
        return getWorkItemsBetweenBuildsAsync(organization, project, fromBuildId, toBuildId, top).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<List<ResourceRefInner>> getWorkItemsBetweenBuildsWithResponse(
        String organization, String project, int fromBuildId, int toBuildId, Integer top, Context context) {
