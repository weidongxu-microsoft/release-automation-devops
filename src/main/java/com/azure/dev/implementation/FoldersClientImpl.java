...
public final class FoldersClientImpl implements FoldersClient {
    private final ClientLogger logger = new ClientLogger(FoldersClientImpl.class);
    ...
    private interface FoldersService {
        @Headers({"Content-Type: application/json"})
        @Put("/{organization}/{project}/_apis/build/folders")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<FolderInner>> create(
            @HostParam("$host") String endpoint,
            @PathParam("organization") String organization,
            @PathParam("project") String project,
            @QueryParam("path") String path,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") FolderInner body,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<FolderInner>> update(
            @HostParam("$host") String endpoint,
            @PathParam("organization") String organization,
            @PathParam("project") String project,
            @QueryParam("path") String path,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<List<FolderInner>>> list(
            @HostParam("$host") String endpoint,
            @PathParam("organization") String organization,
            @PathParam("project") String project,
            @PathParam("path") String path,
            @QueryParam("queryOrder") FolderQueryOrder queryOrder,
            @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept,
            Context context);
    }
    ...
    private Mono<Response<FolderInner>> createWithResponseAsync(
        String organization, String project, String path, FolderInner body) {
        ...
        return FluxUtil
            .withContext(
                context ->
                    service
                        .create(
                            this.client.getEndpoint(), organization, project, path, apiVersion, body, accept, context))
    ...
    private Mono<Response<FolderInner>> createWithResponseAsync(
        ...
        return service
            .create(this.client.getEndpoint(), organization, project, path, apiVersion, body, accept, context);
    }
    ...
    public FolderInner create(String organization, String project, String path, FolderInner body) {
        return createAsync(organization, project, path, body).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<FolderInner> createWithResponse(
        String organization, String project, String path, FolderInner body, Context context) {
    ...
    private Mono<Response<Void>> deleteWithResponseAsync(String organization, String project, String path) {
        ...
        return FluxUtil
            .withContext(
                context -> service.delete(this.client.getEndpoint(), organization, project, path, apiVersion, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Void>> deleteWithResponseAsync(
        String organization, String project, String path, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
        ...
        final String apiVersion = "6.0";
        context = this.client.mergeContext(context);
        return service.delete(this.client.getEndpoint(), organization, project, path, apiVersion, context);
    }
    ...
    private Mono<Void> deleteAsync(String organization, String project, String path) {
        return deleteWithResponseAsync(organization, project, path).flatMap((Response<Void> res) -> Mono.empty());
    }
    ...
    public void delete(String organization, String project, String path) {
        deleteAsync(organization, project, path).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<FolderInner>> updateWithResponseAsync(
        String organization, String project, String path, FolderInner body) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
    ...
    private Mono<Response<FolderInner>> updateWithResponseAsync(
        ...
        context = this.client.mergeContext(context);
        return service
            .update(this.client.getEndpoint(), organization, project, path, apiVersion, body, accept, context);
    }
    ...
    public FolderInner update(String organization, String project, String path, FolderInner body) {
        return updateAsync(organization, project, path, body).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<FolderInner> updateWithResponse(
        String organization, String project, String path, FolderInner body, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<List<FolderInner>>> listWithResponseAsync(
        String organization, String project, String path, FolderQueryOrder queryOrder) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private Mono<Response<List<FolderInner>>> listWithResponseAsync(
        ...
        context = this.client.mergeContext(context);
        return service
            .list(this.client.getEndpoint(), organization, project, path, queryOrder, apiVersion, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<List<FolderInner>> listAsync(
        String organization, String project, String path, FolderQueryOrder queryOrder) {
        return listWithResponseAsync(organization, project, path, queryOrder)
            .flatMap(
                (Response<List<FolderInner>> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
    ...
    public List<FolderInner> list(String organization, String project, String path) {
        final FolderQueryOrder queryOrder = null;
        return listAsync(organization, project, path, queryOrder).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<List<FolderInner>> listWithResponse(
        String organization, String project, String path, FolderQueryOrder queryOrder, Context context) {
