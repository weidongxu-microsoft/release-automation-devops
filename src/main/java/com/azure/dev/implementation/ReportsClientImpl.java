...
public final class ReportsClientImpl implements ReportsClient {
    ...
    private interface ReportsService {
        ...
        Mono<Response<BuildReportMetadataInner>> get(
    ...
    private Mono<Response<BuildReportMetadataInner>> getWithResponseAsync(
    ...
    private Mono<Response<BuildReportMetadataInner>> getWithResponseAsync(
        ...
        return service
            .get(this.client.getEndpoint(), organization, project, buildId, type, apiVersion, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<BuildReportMetadataInner> getAsync(String organization, String project, int buildId, String type) {
        return getWithResponseAsync(organization, project, buildId, type)
            .flatMap(
                (Response<BuildReportMetadataInner> res) -> {
    ...
    public BuildReportMetadataInner get(String organization, String project, int buildId) {
        final String type = null;
        return getAsync(organization, project, buildId, type).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BuildReportMetadataInner> getWithResponse(
        String organization, String project, int buildId, String type, Context context) {
